 <!-- ========================================================= -->
<!--          GitHub Profile README — Navneet Kumar            -->
<!-- ========================================================= -->
...
<img src="https://user-images.githubusercontent.com/74038190/213760710-201a57d2-95f1-45c7-b910-44faf209d2f8.gif" width="480"/>
...
<img src="https://user-images.githubusercontent.com/74038190/213760705-0d5bf320-4f43-4352-b74b-0889ae726bf7.gif" width="90"/>
...
**Tools & Platforms**
<br/>
<img src="https://skillicons.dev/icons?i=git,github,postman,vscode,idea,linux,vercel&theme=dark" />
...
### 🧩 [Job Portal](https://github.com/YOUR_USERNAME/YOUR_REPO)
**React · Node · Express · MongoDB · JWT**

Modular RESTful backend (MVC + SOLID) with 3 role-based access levels, a responsive React front end with 10+ reusable components, 80% test coverage, and zero-downtime CI/CD on Vercel/Render.

</td>
<td width="50%">

### 📚 [Digital Bookshelf](https://github.com/YOUR_USERNAME/YOUR_REPO)
**HTML5 · CSS3 · Vanilla JS**

Multi-filter search across 500+ book entries using an indexed data structure for O(n) lookup, with localStorage persistence — zero framework dependency.
...
### 🤖 [AI Credit Risk Scoring System](https://github.com/YOUR_USERNAME/YOUR_REPO)
**Python · Scikit-learn · Pandas · NumPy · Matplotlib**

Trained and benchmarked Logistic Regression, Random Forest, and Decision Tree classifiers across 10,000+ records — 85% test accuracy, with feature-importance visualizations.
...
- 🧩 **350+ problems** solved — LeetCode · Codeforces · CodeChef · CSES
...
- 📜 Salesforce Trailhead — Developer Fundamentals (Apex, LWC)
